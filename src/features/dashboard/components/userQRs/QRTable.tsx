			...
			<Table className="w-full">
				<TableHeader className="bg-gradient-to-r from-primary/60 via-background to-muted ">
					<TableRow className="hover:bg-transparent border-accent/40">
						...
						<TableHead className="text-lg text-primary-foreground font-semibold">Content</TableHead>
						<TableHead className="text-lg text-primary-foreground font-semibold">Created</TableHead>
						<TableHead className="w-[120px] text-lg text-primary-foreground font-semibold rounded-tr-xl text-end px-6">Actions</TableHead>
					</TableRow>
				</TableHeader>
