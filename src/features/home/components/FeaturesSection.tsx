...
const features = [
    {
        ...
        description:
            'Create unique designs with your logo, brand colors, and specific information.',
        // icon: Icons.palette,
        color: 'primary',
    },
    {
    ...
    },
    {
        ...
        description:
            'Choose from multiple templates designed for different types of organizations.',
        // icon: Icons.template,
        color: 'secondary',
    },
    {
            ...
            <div className="max-w-7xl mx-auto">
                <div className="text-center mb-16">
                    ...
                    <p className="mt-4 text-lg text-muted-foreground max-w-3xl mx-auto">
                        Designed for teams that need professional identification and access
                        management.
                    </p>
                </div>
