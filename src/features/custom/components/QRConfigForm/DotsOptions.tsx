...
import type { DotsOptions, DotsOptionsHelper, DotShapeType } from '@/types';
...
export const DotsOptionsForm = ({ dotsOptions, dotsOptionsHelper, onChange, onChangeHelper }: DotsOptionsProps) => {
                ...
                <div className="space-y-4">
                    <div className="space-y-2">
                        ...
                        <Select
                            ...
                            onValueChange={(value: DotShapeType) => 
                    ...
                    {/* <div className="flex items-center justify-between">
                        <Label htmlFor="roundSize">Adjust size for rounded shapes</Label>
                        <Switch
                            id="roundSize"
                            checked={dotsOptions.roundSize || false}
                            onCheckedChange={(checked) => 
                                onChange({ ...dotsOptions, roundSize: checked })
                        }
                        />
                    </div> */}
                </div>
