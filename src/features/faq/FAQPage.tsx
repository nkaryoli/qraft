            ...
            >
                <motion.div variants={item} className="flex flex-col items-center">
                    <Accordion
                        type="single"
                        collapsible
                        className="w-full max-w-2xl space-y-2 bg-gradient-to-br from-primary/30 via-background to-muted/30 p-2 rounded-lg"
                    >
                        <AccordionItem
                            value="what-is-qraft"
                            className="bg-gradient-to-b from-background to-black rounded-lg px-6"
                        >
                            <AccordionTrigger className="text-xl font-medium">
                                What is Qraft?
                            </AccordionTrigger>
                            <AccordionContent className="text-muted-foreground">
                                Qraft is a comprehensive platform that allows you to create
                                customized QR codes and digital identification badges. Whether
                                you're an individual looking to create unique QR codes or an
                                organization managing employee badges, Qraft provides the tools you
                                need.
                            </AccordionContent>
                        </AccordionItem>
                        ...
                        >
                            ...
                            <AccordionContent className="text-muted-foreground">
                                With Qraft, you can customize various aspects of your QR codes
                                including:
                        ...
                        >
                            ...
                            <AccordionContent className="text-muted-foreground">
                                Digital badges serve as modern identification credentials.
                                Organizations can:
                                <ul className="list-disc ml-6 mt-2 space-y-1 text-lg">
