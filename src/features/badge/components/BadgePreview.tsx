    ...
    >
      ...
      {config.content.logoUrl ? (
        <div className="flex w-full justify-center items-center gap-3 mb-6 h-20">
          ...
          />
          <p className="text-lg font-medium opacity-90">{config.content.organization || 'Organization Name'}</p>
        </div>
      ) : (
      ...
      <div className="flex flex-col items-center mb-8">
        ...
        <div className="flex flex-col items-center gap-2">
          <p className="text-lg font-medium opacity-90">{config.content.position || 'Position'}</p>
          <p className="text-sm opacity-75">{config.content.department || 'Department'}</p>
        </div>
